...
class TestConditie(unittest.TestCase):
    ...
    def test_conditie_eligibil_bursa(self):
        s = NotareStudent(0,0,0)
        _, _, eligibil_bursa, _ = s.evaluare_student(90, 90, 90)
        self.assertTrue(eligibil_bursa)
        
    def test_conditie_bursa_prezenta_peste_prag(self):
        s = NotareStudent(0,0,0)
        _, _, eligibil_bursa, _ = s.evaluare_student(90, 90, 90)
        self.assertTrue(eligibil_bursa)
    ...
    def test_conditie_bursa_nota_sub_prag(self):
        s = NotareStudent(0,0,0)
        _, _, eligibil_bursa, _ = s.evaluare_student(84, 85, 80)
        self.assertFalse(eligibil_bursa)

    def test_conditie_bursa_prezenta_sub_prag(self):
        s = NotareStudent(0,0,0)
        _, _, eligibil_bursa, _ = s.evaluare_student(90, 90, 79)
        self.assertFalse(eligibil_bursa)
